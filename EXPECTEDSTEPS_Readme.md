...
* p(Gi) is the probability the solution is in group Gi. p(Gi) is always n/(# of words). Here 'n' is the number of words in group Gi. The '# of words' is the number of possible remaining solutions.
