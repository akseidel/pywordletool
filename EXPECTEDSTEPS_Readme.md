...
* GOLEM's table is as follows. GOLEM has an E()=2.32 expected number of steps. The E( ) is larger than that for UNLET and GILET as might be expected since there are 16 outcomes versus 18 outcomes.
