...
Jargon words and fundamental are used here to avoid cluttering this writing. These are defined at the end in a section named **Definitions**.
...
* p(Gi) is the probability the solution is in group Gi. p(Gi) is always 1/(# of words). The # of words is the number of possible remaining solutions.
